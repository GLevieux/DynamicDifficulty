...
if(V2 == TRUE)
{
  ...
  DTGame <- load_data(DTGame,"kak@shi") #Homme
  DTGame <- load_data(DTGame,"Clement") #Homme
  DTGame <- load_data(DTGame,"Cronuk") #Homme
  DTGame <- load_data(DTGame,"thomas") #Homme
  DTGame <- load_data(DTGame,"william") #Homme
  ...
  DTGame <- load_data(DTGame,"spotblue") #Homme
  DTGame <- load_data(DTGame,"Indromak") #Homme
  DTGame <- load_data(DTGame,"Roro") #Femme
