...
for(i in 1:nrow(DTLevel)){
  ...
  if(i==1){
    ...
    p = p + geom_path(x=DT$difficulty,y=DT$estDiff, alpha = 0.2,size=1,colour=rgb(0.1, 0.2, 0.8, 0.3))
  }
}
...
print(p)
  ...
  # 
  # p <- p + xlab("Variable de difficulté") + ylab(paste("Difficulté objective à t=",time)) + theme(text = element_text(size=20))
  # 
  # print(p)
