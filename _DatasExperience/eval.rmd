...
plot(x=DTGame$step,y=DTGame$variation.Model, pch = 20, col=rgb(0.1, 0.2, 0.8, 0.2), xlab="Game Step", ylab="Model Variation")
plot(x=DTGame$step,y=DTGame$param.Diff, pch = 20, col=rgb(0.1, 0.2, 0.8, 0.2), xlab="Game Step", ylab="Difficulty Parameter (theta)")
