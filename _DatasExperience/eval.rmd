...
if(V2 == TRUE)
{
  ...
  DTGame <- load_data(DTGame,"V2/WilliamV2"      , 1,-1)
  DTGame <- load_data(DTGame,"V2/thomasV2"       , 1,-1)
  DTGame <- load_data(DTGame,"V2/kak@shiV2"      ,-1, 0)
  DTGame <- load_data(DTGame,"V2/CronukV2"       ,-1, 0)
...
<<<<<<< HEAD
  ...
  DTGame <- load_data(DTGame,"kak@shi"      ,-1,-1)
  DTGame <- load_data(DTGame,"Clement"      , 1,26)
  DTGame <- load_data(DTGame,"Cronuk"       ,-1,-1)
  DTGame <- load_data(DTGame,"thomas"       , 1,-1)
  DTGame <- load_data(DTGame,"william"      , 1,-1)
  ...
  DTGame <- load_data(DTGame,"spotblue"     ,-1,-1)
  DTGame <- load_data(DTGame,"Indromak"     ,-1,-1)
  DTGame <- load_data(DTGame,"Roro"         ,-1,-1)
  DTGame <- load_data(DTGame,"ak"           ,-1,-1) 
...
>>>>>>> 381cf4ec0f1f83d816e9849d8f32539939381627
}
