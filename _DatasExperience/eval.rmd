...
#on ajoute la diff prévue par un modèle a effets mixtes
...
#oon evalue la qualité de cette regression mixte
...
#on caulcule a quel point la pobjective de fail pour les 3 niveaux de diff est précise
...
#evaluation de la variabilité de beta1 (pent de la courbe)
DTLevel <- DTGame[step==60]
